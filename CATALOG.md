...
| Pre-Mortem Analyzer | `pre-mortem-analyzer` | 0.1.0 | Text | Forces identification of failure modes and risks before committing to a plan or decision. | Shipped |
| Devil’s Advocate Simulator | `devils-advocate-simulator` | 0.1.0 | Text | Systematically attacks your current line of thinking to surface weaknesses, counterarguments, and blind spots. | Shipped |
| Assumption Challenger | `assumption-challenger` | 0.1.0 | Text | Identifies and stress-tests the hidden assumptions underlying a plan, belief, or analysis. | Shipped |
